...
const STATS = [
  ...
  { value: 3, suffix: "rd", label: "Year of B.Tech" },
];
...
const JOURNEY = [
  {
    ...
    description:
      "Began B.Tech in Computer Science Engineering at BVRIT Hyderabad College of Engineering for Women.",
  },
  {
    year: "2025",
    title: "Building Real Projects",
    description:
      "Started building full-stack apps and games — including a browser-based 3D maze game and a college event platform.",
  },
  {
    year: "2026",
    title: "Internship & Hackathons",
    description:
      "Completed a data analytics internship at DecodeLabs and built projects for national-level hackathons, including a full-stack hospital dashboard.",
  },
  {
    year: "Now",
    title: "Looking Ahead",
    description:
      "Building a portfolio aimed at software engineering and game development internships.",
  },
];
    ...
    <section ref={sectionRef} id="about" className="relative py-32 md:py-48">
      <div className="section-container">
        <SectionHeading
          ...
          subtitle="A Computer Science student who treats every project as a chance to learn something new — from full-stack apps to browser-based games."
        />
